// pages/test_answer_detail/test_answer_detail.js
...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        wx.request({
          url: app.globalData.baseUrl+'wx/subject_answer_list',
          data: {
            oid: that.data.oid,
            ceshiid: options.id
          },
          success: function (res) {
            ...
            if (res.data.result == "fail") {
              ...
              if (that.data.id == 1) {
                ...
                if (res.data.ceshimbtianswer.length == 0) {
                  that.setData({
                    disflag: false
                  })
                } else {
  ...
  testDetail:function (e) {
    wx.redirectTo({
      url: '../test_intro/test_intro?id=' + this.data.id,
    })
  },
